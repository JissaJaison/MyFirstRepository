...
@DatabaseTable(tableName="PermissionGroups_Departments")
public class PermissionGroups_Departments extends SQLiteOfflineEntity 
 
{
 
 
@Key 
@DatabaseField(columnName="PermissionGroups_DepartmentsID", canBeNull = false)
public Integer PermissionGroups_DepartmentsID; 
