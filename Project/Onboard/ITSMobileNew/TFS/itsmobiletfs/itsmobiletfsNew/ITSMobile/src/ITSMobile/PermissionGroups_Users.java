...
@DatabaseTable(tableName="PermissionGroups_Users")
public class PermissionGroups_Users extends SQLiteOfflineEntity 
 
{
 
 
@Key 
@DatabaseField(columnName="PermissionGroups_UsersID", canBeNull = false)
public Integer PermissionGroups_UsersID; 
