...
@DatabaseTable(tableName="Transverses")
public class Transverses extends SQLiteOfflineEntity 
 
{
 
 
@Key 
@DatabaseField(columnName="TransverseID", canBeNull = false)
...
@DatabaseField(columnName="TransverseName", canBeNull = false)
